...
function EMS() {
  const { t } = useLang()
  const e = t.ems
  const imgs = ['/ems-1.png', '/ems-2.png', '/ems-3.png']

  return (
    <section id="ems" className="w-full py-20 px-16" style={{ backgroundColor: '#F6F4F0' }}>
      <div className="flex items-center justify-center gap-4 mb-16">
        <div className="flex-1 h-px" style={{ backgroundColor: '#c5bfb3' }} />
        <h2 className="text-xl font-light tracking-widest" style={{ color: '#8a8472' }}>{e.title}</h2>
        <div className="flex-1 h-px" style={{ backgroundColor: '#c5bfb3' }} />
      </div>
      ...
      <div className="flex items-center gap-16 mb-20">
        ...
        <div style={{ width: '480px', flexShrink: 0 }}>
          <div className="w-full overflow-hidden" style={{ height: '500px', borderRadius: '9999px 9999px 0 0' }}>
            <img src="/ems-main.png" alt="EMS" className="w-full h-full object-cover" />
          </div>
        </div>
      </div>
