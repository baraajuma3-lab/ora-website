...
function Fizyoterapi() {
  const { t } = useLang()
  const f = t.fizyo
  const imgs = ['/f-1.png', '/f-2.png', '/f-3.png']

  return (
    <section id="fizyoterapi" className="w-full py-20 px-16" style={{ backgroundColor: '#F6F4F0' }}>
      <div className="flex items-center justify-center gap-4 mb-16">
        <div className="flex-1 h-px" style={{ backgroundColor: '#c5bfb3' }} />
        <h2 className="text-xl font-light tracking-widest" style={{ color: '#8a8472' }}>{f.title}</h2>
        <div className="flex-1 h-px" style={{ backgroundColor: '#c5bfb3' }} />
      </div>
      ...
      <div className="flex items-center gap-16 mb-20">
        ...
        <div style={{ width: '480px', flexShrink: 0 }}>
          <div className="w-full overflow-hidden" style={{ height: '500px', borderRadius: '9999px 9999px 0 0' }}>
            <img src="/fizo-main.png" alt="Fizyoterapi" className="w-full h-full object-cover" />
          </div>
        </div>
      </div>
